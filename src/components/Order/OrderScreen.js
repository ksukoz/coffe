			...
			(x, y, w, h) => {
				if (value > w + y && !this.state.canceled) {
					if (
						...
						(this.state.city !== this.props.user.city && this.state.city !== 'Город, область')
					) {
					...
					this.setState(
						...
						() =>
							this.state.city && this.state.city !== 'Город, область'
								? this.props.getDeliveryCost(this.state.city)
								: ''
					);
				}
			}
		...
		return (
			<Container style={styles.default}>
				<StatusBar
					...
					hidden={false}
					translucent={true}
					backgroundColor={`rgba(0,0,0,${this.state.focus
						? 0.1
						: this.state.opacity || this.state.modalVisible2 ? 0.7 : 0})`}
				/>
				<View style={{ flex: 1 }}>
					<ScrollView
					...
					<SearchBar
						...
						cartChanged={() => this.state.cart.map((item) => this.props.updateCart(item.id, item.qty))}
					/>
					...
					{this.state.loading ? (
						...
						<Content style={{ marginTop: scaleSize(99) }} onScroll={(e) => this.handleScroll(e)}>
							<FlatList
								style={{
							...
							>
								...
								<View style={styles.block}>
									...
									<Input
										...
										onChangeText={(value) => this.changeHandler(value, 'firstname')}
									/>
									<Label
										style={{
											color: '#302c23',
									...
									<Input
										...
										onChangeText={(value) => this.changeHandler(value, 'lastname')}
									/>
										...
										<View>
											...
											{np ? (
												...
												>
													...
													<Text style={styles.defaultText}>
														{np.filter((item) => item.value === 'warehouse')[0].cost} грн
													</Text>
												</TouchableOpacity>
											) : null}
											{up ? (
											...
											{up ? (
												...
												>
													...
													<Text style={styles.defaultText}>
														{up.filter((item) => item.value === 'warehouse')[0].cost} грн
													</Text>
												</TouchableOpacity>
											) : null}
											{upx ? (
											...
											{upx ? (
												...
												>
													...
													<Text style={styles.defaultText}>
														{upx.filter((item) => item.value === 'warehouse')[0].cost} грн
													</Text>
												</TouchableOpacity>
											) : null}
										</View>
										...
										<View>
											...
											>
												<View style={{ flexDirection: 'row' }}>
													...
													/>
													<Text style={styles.defaultText}>VISA, Mastercard</Text>
												</View>
												<View
													style={{
														flexDirection: 'row',
											...
											>
												<View style={{ flexDirection: 'row' }}>
													...
													/>
													<Text style={styles.defaultText}>LiqPay, Privat24</Text>
												</View>
												<View
													style={{
														flexDirection: 'row',
											...
											<TouchableOpacity
												...
												onPress={() =>
													this.setState({
														payment: payment === 'Masterpass' ? '' : 'Masterpass'
													})}
											>
												<View style={{ flexDirection: 'row' }}>
													<CheckBox
													...
													/>
													<Text style={styles.defaultText}>VISA Checkout, Masterpass</Text>
												</View>
												<View
													style={{
														flexDirection: 'row',
...
=======
							...
							>
								<Text style={{ fontSize: scaleSize(16), color: '#fff' }}>Товары:</Text>
								<Text style={{ fontSize: scaleSize(16), color: '#fff' }}>
									{product ? (
										product.qty * product.price
									) : (
				...
				>
					...
					>
						...
						<Text>
							Вы указали новые данные, использовать их для следующих заказов, обновив ими старые данные?
						</Text>
						<View style={{ flexDirection: 'row', justifyContent: 'flex-end' }}>
							<TouchableOpacity
								style={{
...
const mapDispatchToProps = (dispatch) => ({
	...
	updateUser: (firstName, lastName, city) => dispatch(updateUser(firstName, lastName, city)),
