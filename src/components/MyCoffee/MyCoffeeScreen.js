...
import {Container, Content, Input, Item, Text, Button, List, ListItem} from 'native-base';
import {
    StyleSheet,
    View,
    ScrollView,
...
export default class MyCoffeeScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            alphabet: [],
    ...
    render() {
        ...
        var data = {
            fieldNames: ['Послевкусие','Тело','Баланс','Кислотность','Полнота', 'Аромат'],
            values: [
                this.state.position,
                [17,17,17,17,17,17]
            ]
                ...
                <ScrollView ref="info" pagingEnabled = { true } horizontal = { true }>
                    <View style={styles.container}>
                        <Content>
                            ...
                            <Text style={{marginTop: 20, color: "#fff", width: '100%', textAlign: 'center', fontSize: 20}}>Меняйте характеристики:</Text>
                            <View style={{flex: 1, flexDirection: 'row', marginTop: 10, justifyContent: "space-around"}}>
                                <Item onPress={() => this.setCoreColor('arabica')} style={{borderBottomWidth: 0, color: "#fff", marginLeft: 5, flexDirection: 'row', flex: 1}}>
                                    <KawaIcon style={this.state.arabica} name={"arabica"} size={24} />
                                    <Text style={this.state.arabicaText}>Арабика</Text>
                                </Item>
                                <Item onPress={() => this.setCoreColor('rabusta')} style={{borderBottomWidth: 0, color: "#fff", marginRight: 20, flexDirection: 'row', flex: 1, justifyContent: 'flex-end'}}>
                                    <KawaIcon style={this.state.rabusta} name={"arabica"} size={24} />
                                    <Text style={this.state.rabustaText}>Робуста</Text>
                                </Item>
                            </View>
                            <View>
                                ...
                                <Item onPress={() => this.viewDescription(0)} style={{padding: 5, borderBottomWidth: 0, position: 'absolute', top: 5, left: Dimensions.get('window').width  / 2 - 55}}><Text style={{color: '#fff', fontSize: 16}}>Послевкусие</Text></Item>
                                <Item onPress={() => this.viewDescription(1)} style={{padding: 5, borderBottomWidth: 0, position: 'absolute', top: 60, left: Dimensions.get('window').width - 80}}><Text style={{color: '#fff', fontSize: 16}}>Тело</Text></Item>
                                <Item onPress={() => this.viewDescription(2)} style={{padding: 5, borderBottomWidth: 0, position: 'absolute', top: 260, left: Dimensions.get('window').width - 80}}><Text style={{color: '#fff', fontSize: 16}}>Баланс</Text></Item>
                                <Item onPress={() => this.viewDescription(3)} style={{padding: 5, borderBottomWidth: 0, position: 'absolute', top: 305, left: Dimensions.get('window').width / 2 - 55}}><Text style={{color: '#fff', fontSize: 16}}>Кислотность</Text></Item>
                                <Item onPress={() => this.viewDescription(4)} style={{padding: 5, borderBottomWidth: 0, position: 'absolute', top: 260, left: 15}}><Text style={{color: '#fff', fontSize: 16}}>Полнота</Text></Item>
                                <Item onPress={() => this.viewDescription(5)} style={{padding: 5, borderBottomWidth: 0, position: 'absolute', top: 60, left: 15}}><Text style={{color: '#fff', fontSize: 16}}>Аромат</Text></Item>
                                <View style={this.state.typeDescriptions[0]}>
                                    <Text style={{fontSize: 19, textAlign: 'left'}}>Послевкусие</Text>
                                    <Text style={{fontSize: 14.5, lineHeight: 20, marginTop: 5}}>Вкусовые тона, которые ощущаются во
                                        рту некоторое время после того, как кофе
                                        выпит. Например, ореховое, винное,
                                        хлебное, шоколадное, цветочное
                                        послевкусие.</Text>
                                </View>
                                <View style={this.state.typeDescriptions[1]}>
                                    <Text style={{fontSize: 19, textAlign: 'left'}}>Тело</Text>
                                    <Text style={{fontSize: 14.5, lineHeight: 20, marginTop: 5}}>Тело — ощущение богатства
                                        или тонкости вкуса, а так же
                                        насыщенности дегустируемого напитка.</Text>
                                </View>
                                <View style={this.state.typeDescriptions[2]}>
                                    <Text style={{fontSize: 19, textAlign: 'left'}}>Баланс</Text>
                                    <Text style={{fontSize: 14.5, lineHeight: 20, marginTop: 5}}>Своеобразный паритет вкусовых
                                        характеристик и оттенков кофе.
                                        Сбалансированным называют кофе у
                                        которого одни вкусовые характеристики
                                        и оттенки не преобладают над другими.</Text>
                                </View>
                                <View style={this.state.typeDescriptions[3]}>
                                    <Text style={{fontSize: 19, textAlign: 'left'}}>Кислотность</Text>
                                    <Text style={{fontSize: 14.5, lineHeight: 20, marginTop: 5}}>Кислотность не имеет ничего общего с
                                        кислым вкусом. Она означает приятную
                                        остроту вкуса, подчеркивает
                                        высокое качество напитка.</Text>
                                </View>
                                <View style={this.state.typeDescriptions[4]}>
                                    <Text style={{fontSize: 19, textAlign: 'left'}}>Полнота</Text>
                                    <Text style={{fontSize: 14.5, lineHeight: 20, marginTop: 5}}>Это плотность, которая ощущается от
                                        кофе на языке. Полнота варьируется от легкой до высокой.</Text>
                                </View>
                                <View style={this.state.typeDescriptions[5]}>
                                    <Text style={{fontSize: 19, textAlign: 'left'}}>Аромат</Text>
                                    <Text style={{fontSize: 14.5, lineHeight: 20, marginTop: 5}}>Пахучие вещества, выделяемые при
                                        заваривании кофе. Интенсивность
                                        аромата оценивается как слабая,
                                        умеренная, сильная и яркая, зависит от
                                        свежести напитка.</Text>
                                </View>
                            </View>
                        </Content>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('Catalog')} style={{backgroundColor: '#ea9308', width: '100%', alignItems: 'center', justifyContent: "space-around", height: 50}}><Text style={{color: '#fff', fontSize: 14.5, fontWeight: 'bold'}}>ПОДОБРАТЬ</Text></TouchableOpacity>
                    </View>
                    <View style={styles.container}>
                        <Content>
                            <View style={styles.head}>
                            ...
                            <View style={{ marginBottom: 40, backgroundColor: 'rgba(255,255,255, 0.7)', borderTopLeftRadius: 5, borderTopRightRadius: 5, borderBottomLeftRadius: 5, borderBottomRightRadius: 5, paddingLeft: 5, paddingRight: 5, marginLeft: '2.2%', marginRight: '2.2%', width: '95.6%' }}>
                                ...
                                <ScrollView style={{marginTop: 15}}>
                                    <Text style={{fontSize: 15, paddingLeft: 13, fontWeight: 'bold'}}>Аромат</Text>
                                    <Text style={{fontSize: 15, paddingLeft: 13, paddingTop: 10, paddingRight: 40}}>Пахучие вещества, выделяемые при
                                        заваривании кофе. Интенсивность
                                        аромата оценивается как слабая,
                                        умеренная, сильная и яркая, зависит от
                                        свежести напитка.</Text>
                                    <Text style={{fontSize: 15, paddingLeft: 13, fontWeight: 'bold', marginTop: 15}}>Баланс</Text>
                                    <Text style={{fontSize: 15, paddingLeft: 13, paddingTop: 10, paddingRight: 40}}>Своеобразный паритет вкусовых
                                        характеристик и оттенков кофе.
                                        Сбалансированным называют кофе у
                                        которого одни вкусовые характеристики
                                        и оттенки не преобладают над другими.
                                    </Text>
                                    <Text style={{fontSize: 15, paddingLeft: 13, fontWeight: 'bold', marginTop: 15}}>Кислотность</Text>
                                    <Text style={{fontSize: 15, paddingLeft: 13, paddingTop: 10, paddingRight: 40}}>Кислотность не имеет ничего общего с
                                        кислым вкусом. Она означает приятную
                                        остроту вкуса, подчеркивает
                                        высокое качество напитка.</Text>
                                    <Text style={{fontSize: 15, paddingLeft: 13, fontWeight: 'bold', marginTop: 15}}>Полнота</Text>
                                    <Text style={{fontSize: 15, paddingLeft: 13, paddingTop: 10, paddingRight: 40}}>Это плотность, которая ощущается от
                                        кофе на языке. Полнота варьируется от легкой до высокой.</Text>
                                    <Text style={{fontSize: 15, paddingLeft: 13, fontWeight: 'bold', marginTop: 15}}>Послевкусие</Text>
                                    <Text style={{fontSize: 15, paddingLeft: 13, paddingTop: 10, paddingRight: 40}}>Вкусовые тона, которые ощущаются во
                                        рту некоторое время после того, как кофе
                                        выпит. Например, ореховое, винное,
                                        хлебное, шоколадное, цветочное
                                        послевкусие.</Text>
                                    <Text style={{fontSize: 15, paddingLeft: 13, fontWeight: 'bold', marginTop: 15}}>Тело</Text>
                                    <Text style={{fontSize: 15, paddingLeft: 13, paddingTop: 10, marginBottom: 20, paddingRight: 40}}>Тело — ощущение богатства
                                        или тонкости вкуса, а так же
                                        насыщенности дегустируемого напитка.</Text>
                                </ScrollView>
                            </View>
