...
import { StatusBar, Dimensions, BackHandler, StyleSheet, View, Text, Image } from 'react-native';
	...
	render() {
		return (
			<Container style={styles.default}>
				...
				<View style={{ flex: 1 }}>
					<Image source={require(MAIN_BG)} style={styles.background} resizeMode="cover" />
							...
							<MyWebView
								...
								source={{
									...
									body: `{
										...
										order: {
											'bill_amount': ${this.props.navigation.getParam('bill_amount')},
											'shop_order_number': ${this.props.orderId},
											'success_url': 'kawaapp://kawa/order-success',
											'failure_url': 'kawaapp://kawa/order-fail'
										},
										'paymentTypes': {
											'card': 'Y',
											'portmone': 'N',
...
export default connect(mapStateToProps, mapDispatchToProps)(PortmoneScreen);
