...
import { Container, Content, Text, Item, Button, Form, Input } from 'native-base';
import {
	StyleSheet,
	View,
	ImageBackground,
				...
				<ScrollView>
					...
					<View style={styles.container}>
						<Content>
							...
							<View style={styles.head}>
								<Item style={{ borderBottomWidth: 0, color: '#fff' }}>
									<Button transparent onPress={() => this.props.navigation.navigate('Home')}>
										<KawaIcon
											style={{ color: '#fff', paddingLeft: 5, paddingRight: 20 }}
											name={'arrow-back2'}
											size={22}
										/>
									</Button>
							...
							<View style={styles.cardFullCity}>
								...
								>
									...
									>
										...
										<KawaIcon
											style={{ color: '#fff', position: 'absolute', right: 10, top: 15 }}
											name={'arrow-next'}
											size={14}
										/>
									</TouchableOpacity>
							...
							>
								<Text style={{ color: '#ffea00', fontSize: 20, marginBottom: 10 }}>Доставка</Text>
								<View
									style={{
										flexDirection: 'row',
										alignItems: 'center',
								...
								>
									...
									>
										...
										>
											<Text style={{ color: '#fff', fontSize: 18 }}>Новая Почта, отделение</Text>
											<Text style={{ color: '#fff', fontSize: 18 }}>50 грн</Text>
										</View>
										<View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
											<Text style={{ color: '#fff', fontSize: 18 }}>Новая Почта, курьер</Text>
											<Text style={{ color: '#fff', fontSize: 18 }}>70 грн</Text>
										</View>
									</View>
								</View>
								<View
								...
								>
									<Image
										...
										style={{ width: 26, height: 37, marginRight: 17, marginLeft: 6 }}
									/>
									<View
										style={{
											flex: 1
									...
									>
										<View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
											<Text style={{ color: '#fff', fontSize: 18 }}>Укрпочта, отделение</Text>
											<Text style={{ color: '#fff', fontSize: 18 }}>30 грн</Text>
										</View>
										<View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
											<Text style={{ color: '#fff', fontSize: 18 }}>Укрпочта, курьер</Text>
											<Text style={{ color: '#fff', fontSize: 18 }}>50 грн</Text>
										</View>
									</View>
								</View>
							...
							>
								<Text style={{ color: '#ffea00', fontSize: 20, marginBottom: 10 }}>Оплата</Text>
								<View
									style={{
										flexDirection: 'row',
										alignItems: 'center',
								...
								>
									<Text style={{ color: '#fff', fontSize: 18, flex: 1 }}>VISA / MasterCard</Text>
									<View>
										<View
											style={{
												flexDirection: 'row',
								...
								>
									<Text style={{ color: '#fff', fontSize: 18, flex: 1 }}>Privat 24</Text>
									<View>
										<Image
								...
								>
									<Text style={{ color: '#fff', fontSize: 18, flex: 1 }}>Google Pay</Text>
									<View>
										<Image
								...
								>
									<Text style={{ color: '#fff', fontSize: 18, flex: 1 }}>Masterpass</Text>
									<View>
										<Image
