...
class OrderSingleScreen extends Component {
	...
	componentWillReceiveProps(nextProps) {
		...
		if (
			...
			nextProps.cart.filter((item) => item.id === this.props.navigation.getParam('itemId'))[0]
		) {
			this.setState({
				loading: false,
										...
										<View>
											...
											>
												<View style={{ flexDirection: 'row' }}>
													...
													/>
													<Text style={styles.defaultText}>Новая Почта, отделение</Text>
												</View>
											...
											>
												<View style={{ flexDirection: 'row' }}>
													...
													/>
													<Text style={styles.defaultText}>Новая Почта, при получении</Text>
												</View>
												{this.props.delivery.length < 6 &&
												this.state.city !== 'Город, область' ? (
													<ActivityIndicator color="#89a6aa" size="small" />
											...
											>
												<View style={{ flexDirection: 'row' }}>
													...
													/>
													<Text style={styles.defaultText}>Новая Почта, курьер</Text>
												</View>
												{this.props.delivery.length < 6 &&
												this.state.city !== 'Город, область' ? (
													<ActivityIndicator color="#89a6aa" size="small" />
											...
											>
												<View style={{ flexDirection: 'row' }}>
													...
													/>
													<Text style={styles.defaultText}>Укрпочта Стандарт</Text>
												</View>
												{this.props.delivery.length < 6 &&
												this.state.city !== 'Город, область' ? (
													<ActivityIndicator color="#89a6aa" size="small" />
											...
											>
												<View style={{ flexDirection: 'row' }}>
													...
													/>
													<Text style={styles.defaultText}>Укрпочта Экспресс</Text>
												</View>
												{this.props.delivery.length < 6 &&
												this.state.city !== 'Город, область' ? (
													<ActivityIndicator color="#89a6aa" size="small" />
											...
											>
												<View style={{ flexDirection: 'row' }}>
													...
													/>
													<Text style={styles.defaultText}>Укрпочта Стандарт, курьер</Text>
												</View>
												{this.state.city !== 'Город, область' &&
												this.props.delivery.length < 6 ? (
													<ActivityIndicator color="#89a6aa" size="small" />
											...
											>
												<View style={{ flexDirection: 'row' }}>
													...
													/>
													<Text style={styles.defaultText}>Укрпочта Экспресс, курьер</Text>
												</View>
												{this.props.delivery.length < 6 &&
												this.state.city !== 'Город, область' ? (
													<ActivityIndicator color="#89a6aa" size="small" />
...
export default connect(mapStateToProps, mapDispatchToProps)(OrderSingleScreen);
