...
export default class HeaderBar extends Component {
	...
	render() {
		...
		return (
			<View style={[ styles.head, this.props.menu ? { marginBottom: scaleSize(20) } : '' ]}>
				<Item
					style={{
						borderBottomWidth: 0,
						color: '#fff',
				...
				>
					...
					>
						<Button
							transparent
							onPress={() => (this.props.menu ? navigation.openDrawer() : navigation.pop())}
						>
							{this.props.menu ? (
					...
					{this.props.catalog ? (
						...
						>
								...
								onPress={() => {
									this.setState(
										...
										this.props.getStyles(
											this.state.index < this.state.images.length - 1 ? this.state.index + 1 : 0
										)
									);
								}}
							>
							...
							>
								...
								<View
									style={{
										opacity: this.props.cart && this.props.cart.length > 0 ? 1 : 0,
										position: 'absolute',
										bottom: 0,
										right: 0,
								...
								>
									...
									>
										{this.props.cart && this.props.cart.length > 0 ? this.props.cart.length : ''}
									</Text>
								</View>
							</TouchableOpacity>
						</View>
