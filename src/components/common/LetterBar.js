...
class LetterBar extends Component {
	...
	componentDidMount() {
		this.props.getAlphabet(this.state.english, this.props.navigation.getParam('categoryId', '0'));
	}
...
export default connect(mapStateToProps, mapDispatchToProps)(LetterBar);
