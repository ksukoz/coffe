...
import {
    Container, Content, Text, Item, Button, Picker, Form, Input,
    Header, Body, Title, Left, Right
} from 'native-base';
import {
    StyleSheet,
    View,
                ...
                <View style={styles.head}>
                    <Item style={{borderBottomWidth: 0, color: '#fff'}}>
                        ...
                        <Text style={{
                            ...
                            fontSize: 20,
                            fontWeight: 'bold'
                        }}>Выберите область</Text>
                    </Item>
                </View>
                <ScrollView style={{marginBottom: 20, backgroundColor: 'rgba(255,255,255, 0.7)', borderTopLeftRadius: 5, borderTopRightRadius: 5, borderBottomLeftRadius: 5, borderBottomRightRadius: 5, paddingLeft: 20, paddingRight: 20, marginLeft: '2.2%', marginRight: '2.2%', width: '95.6%'}}>
                    <FlatList
                        data={this.state.regions}
                        ItemSeparatorComponent={this.renderSeparator}
                        renderItem={({item, separators}) => (
                            <TouchableOpacity
                                style={{paddingLeft: 0, paddingRight: 0, alignItems: 'flex-start', height: 58, width: '100%', marginLeft: 0, marginRight: 0, justifyContent: 'center'}}
                                button
